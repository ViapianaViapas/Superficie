...
///
/// Inicio             : 06/09/2022
/// Ultima modificacao : 13/09/2022 15:30
///
///*******************************************************
...
int  LoadBMP()
{
    ...
    {
        cout << endl << "******************************************************";
        cout << endl << " Infelizmente nesta vesao o programa aceita          *";
        cout << endl << " somente aqruivos BMP de 24 bits de profundidade.    *";
        cout << endl << "                                                     *";
        cout << endl << " Use um BMP de 24 bits em tons de cinza (gray sacle) *";
        cout << endl << "******************************************************";
        getchar();
        return -1;
    }
